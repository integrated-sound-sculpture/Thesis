...
The accuracy of the calibration was tested using 2 different environments. The results can be seen below. 

MOET IK NOG DOEN

The delay of the entire calibration in the loop is approximately ... s. this includes the conversion from input frequency to hand position and the conversion from hand position to output frequency. 
