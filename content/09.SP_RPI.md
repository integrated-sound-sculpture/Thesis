...
### Verification
To test the functionalities listed in the [SP overview](#chapter-sp-overview) and establish that all relevant requirements are met, the functionality of [](#code-code-rpi-full) must be verified.
