...
For the educational and interactive requirement given by the client, a method of giving visual feedback, which represents the sound heard, should be given to the user. This visualization had to be both real-time and easy to read. For educational value, a pedagogue and teacher has been asked about which visualizations are worth adding. In their opinion, all visualization could add value, as long as no extra understanding is needed and when it is needed it should be handled in the NLT module.
