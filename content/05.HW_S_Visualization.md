...
## Design Description
The visualisation is implemented in the same microprocessor as used in the Signal Processing submodule which is a Raspberry Pi 4, this choice is substantiated [here](sec-RPI).
